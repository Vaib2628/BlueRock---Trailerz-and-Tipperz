...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'BlueRock Tippers & Trailerz', url: SITE_URL }],
  creator: 'BlueRock Tippers & Trailerz',
  publisher: 'BlueRock Tippers & Trailerz',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'BlueRock Tippers & Trailerz — Commercial Vehicle Body Fabricators, Pune',
      },
    ],
  },
  twitter: {
